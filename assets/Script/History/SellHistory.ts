...
export default class NewClass extends cc.Component {
    ...
    public fetchIndex() {
        ...
        var url = `${this.app.UrlData.host}/api/sell_gold/sellGoldHistory?&user_id=${this.app.UrlData.user_id}&status=${this.status}&page=${this.page}&page_set=7&token=${this.app.token}&version=${this.app.version}`;
        fetch(url, {
            method: 'get'
