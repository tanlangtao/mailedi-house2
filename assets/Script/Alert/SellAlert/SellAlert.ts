...
export default class NewClass extends cc.Component {
    ...
    setPrice() {
        this.app.showKeyBoard(this.priceLabel,3);
    }

    setSill() {
        this.app.showKeyBoard(this.sillLabel,1);
    }
    public fetchIndex() {
    ...
    public submitSellGoldInfo(){
        ...
        this.FormData.append('exchange_price', this.priceLabel.string)
        this.FormData.append('pay_account', JSON.stringify(pay_account))
        this.FormData.append('min_gold', this.sillLabel.string)
    ...
    deletePrice(){
        this.priceLabel.string = '点击输入';
        this.app.setInputColor('',this.priceLabel);
    }

    deleteSill(){
        this.sillLabel.string = '点击输入';
        this.app.setInputColor('',this.sillLabel);
    }
    removeSelf(){
        this.node.destroy();
    }
